...
async function main(): Promise<unknown> {
  ...
  switch (parsed.command) {
    ...
    case "trigger":
      return runTriggerSuite({ runDir: option(o, "run-dir")!, version: option(o, "version")!, hosts: hosts(o), repetitions: numberOption(o, "repetitions", 1), timeoutMs: numberOption(o, "timeout-ms", 60_000), concurrency: numberOption(o, "concurrency", 6), attemptId: option(o, "attempt-id", false), partition: partition(o, true), queryIds: o.has("queries") ? list(o, "queries") : undefined, models: models(o), reasoningEfforts: reasoningEfforts(o), limits: limits(o), resume: option(o, "resume", false) === "true" });
    case "benchmark":
